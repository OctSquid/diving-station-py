...
from diving_station_py.protocol import DeviceInfo, hand_bend
from .event import AsyncEventHandler, ConnectEvent, ControllerInputReceivedEvent, DeviceInfoReceivedEvent, DisconnectEvent, EventType, HandBendReceivedEvent, HandQuatReceivedEvent, HapticEvent, WristReceivedEvent
...
class DivingStationClient:
  ...
  async def send_haptic(self, device_id: int, hand_type: hand_bend.HandType, frequency: float = ..., amplitude: float = ..., duration: float = ...): # -> None:
    """デバイスの振動要求を送信します。
